      ...
      setTimeout(function () {
        if (!_this.state.errors) {
          ...
          emailjs_com__WEBPACK_IMPORTED_MODULE_15___default.a.send('OniDev', 'onidev', {
            ...
            receiverEmail: 'oni.contact@gmail.com',
            number: 0,
            total: _this.state.total,
            addOns: _this.state.addOns.map(function (addOn, index) {
              return addOn;
            }),
            numAddOns: !_this.state.activeNumAddOns ? 'No Add Ons' : _this.state.activeNumAddOns.map(function (addOn, index) {
...
//# sourceMappingURL=index.js.4cb2bc52c1ec95aa6b53.hot-update.js.map