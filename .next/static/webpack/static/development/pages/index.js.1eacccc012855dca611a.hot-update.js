...
var ProductProvider = /*#__PURE__*/function (_Component) {
  ...
  function ProductProvider() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "handleErrors", function (e) {
      ...
      setTimeout(function () {
        _this.setState(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])({
          message: '',
          email: '',
          number: ''
        }, "message", ''));

        if (_this.state.name = "Name field shouldn't be empty") {
          _this.setState({
            name: ""
          });
        } else {
        ...
        if (_this.state.number = "Number field shouldn't be empty") {
          _this.setState({
            number: ''
          });
        } else {
        ...
        if (_this.state.email = "Email field shouldn't be empty") {
          _this.setState({
            email: ''
          });
        } else {
        ...
        if (_this.state.message = "Message field shouldn't be empty") {
          _this.setState({
            message: ''
          });
        } else {
...
//# sourceMappingURL=index.js.1eacccc012855dca611a.hot-update.js.map