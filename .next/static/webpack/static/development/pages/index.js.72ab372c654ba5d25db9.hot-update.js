    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "selectAddOn", function (addOn) {
      if (_this.state.addOns.includes(addOn.title)) {
        ...
        setTimeout(function () {
          ...
          _this.setState({
            addOnTotal: Math.roundthis.state.addOnTotal - addOn.hours * ratePerHour * Math.PI
          });
        }, 300);
        setTimeout(function () {
          _this.setTotal();
        ...
        setTimeout(function () {
          _this.setState({
            addOnTotal: _this.state.addOnTotal + addOn.hours * ratePerHour * Math.PI
          });
        }, 300);
        setTimeout(function () {
          _this.setTotal();
...
//# sourceMappingURL=index.js.72ab372c654ba5d25db9.hot-update.js.map