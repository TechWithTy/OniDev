...
var ProductProvider = /*#__PURE__*/function (_Component) {
  ...
  function ProductProvider() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "addOnIncriment", function (addOn) {
      if (!_this.state.activeNumAddOns.includes(addOn)) {
        _this.state.activeNumAddOns.push(addOn);

        setTimeout(function () {
          console.warn(_this.state.activeNumAddOns, 'ActiveAddONs');
        }, 300);
      } else {
        console.log("Num Add On Found");
      }

      console.warn(_this.state.activeNumAddOns);
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "clearNumAddOn", function (filter) {
      var filtered = filter.filter(function (obj) {
        return obj.count !== 0;
      });

      _this.setState({
        activeNumAddOns: filtered
      });
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "addOnDecriment", function (addOn) {
      if (addOn.count > 0) {
        ...
        if (addOn.count === 0) {
          var tempAddOns = _this.state.activeNumAddOns.filter(function (obj) {
            return obj !== addOn;
          });

          ;

          _this.clearNumAddOn(tempAddOns);

          console.error(tempAddOns, 'Temp Add');
        }

        console.log("".concat(_this.state.addOnTotal, " -\n            ").concat(addOn.hours, " * ").concat(addOn.count, " * ").concat(ratePerHour, " * ").concat(Math.PI));
...

      {
        servicePackage.addOns.map(function (addOn, index) {
          if (_this.state.addOns.includes(addOn)) {
            ...
            setTimeout(function () {
              console.warn(_this.state.addOns);
            }, 300);
          }
        });
      }
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "handleModal", function (e) {
      !_this.state.errors && _this.setState({
      ...
      setTimeout(function () {
        if (!_this.state.errors) {
          ...
          emailjs_com__WEBPACK_IMPORTED_MODULE_15___default.a.send('OniDev', 'onidev', {
            ...
            addOns: !_this.state.activeNumAddOns.length > 0 ? "No Add Ons" : _this.state.addOns.map(function (addOn, index) {
              return addOn;
            }),
            numAddOns: !_this.state.activeNumAddOns.length > 0 ? 'No Add Ons' : _this.state.activeNumAddOns.map(function (addOn, index) {
              return "(".concat(addOn.count, ") ").concat(addOn.title);
            })
          ...
          console.error('*Submit Error*', _this.state.errors);
        }
      }, 300);
    });
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "handleErrors", function (e) {
      ...
      if (!_this.state.name) {
        ...
        _this.setField('name', 'First Name field shouldn’t be empty');
      }
      ...
      setTimeout(function () {
        ...
        _this.setState((_this$setState = {
          message: _this.state.message == "Message field shouldn’t be empty" && '',
          email: _this.state.email == "Email field shouldn’t be empty" && '',
          number: ''
        }, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(_this$setState, "message", ''), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(_this$setState, "name", ''), _this$setState));
      }, 1000);
      console.warn(error, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_6___default()(error).length, "Set Errors Block");
      ...
      console.warn(_this.state.errors, 'Errors'); // setInterval(() => {
      //           
      // }, 300)
    });
...
//# sourceMappingURL=index.js.b175f59a9c789f665ce5.hot-update.js.map