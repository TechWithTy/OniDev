...
var ProductProvider = /*#__PURE__*/function (_Component) {
  ...
  function ProductProvider() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "handleErrors", function () {
      var error = {};

      if (!_this.state.name) {
        error.name = 'First Name field shouldn’t be empty';

        _this.setField(_this.state.name, error.name);
      }

      if (!_this.state.email) {
        error.email = 'Email field shouldn’t be empty';

        _this.setField(_this.state.email, error.name);
      }

      if (!_this.state.message) {
        error.message = 'Message field shouldn’t be empty';

        _this.setField(_this.state.message, error.name);
      }
...
//# sourceMappingURL=index.js.5a4188ff72e747e770c4.hot-update.js.map