...
var ProductProvider = /*#__PURE__*/function (_Component) {
  ...
  function ProductProvider() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_13__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__["default"])(_this), "handleErrors", function (e) {
      ...
      if (!_this.state.name) {
        error.name = 'First Name field shouldn’t be empty'; //  this.setField('name', 'First Name field shouldn’t be empty');
      }

      if (!_this.state.number) {
        error.number = 'Number field shouldn’t be empty'; // this.setState({ number: 'Number field shouldn’t be empty' });
      }

      if (!_this.state.email) {
        error.email = 'Email field shouldn’t be empty'; // this.setState({ email: 'Email field shouldn’t be empty' });
      }

      if (!_this.state.message) {
        error.message = 'Message field shouldn’t be empty'; // this.setState({ message: 'Message field shouldn’t be empty' });
      }
      ...
      console.warn(_this.state.errors, 'Errors');
    });
...
//# sourceMappingURL=index.js.c009e432a53ab74399af.hot-update.js.map