...
function Contact(props) {
  ...
  var handleInfo = function handleInfo() {
    ...
    setTimeout(function () {
      ...
      console.warn(typeof productConsumer.errors, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(productConsumer.errors).length);

      if (!_babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(productConsumer.errors).length === 0) {
        alert("Errors");
      } else {
  ...
  return __jsx("section", {
    ...
    ChangeValue: productConsumer.setValue,
    Class: productConsumer.errors.number && 'error',
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 101,
...
//# sourceMappingURL=index.js.87d5f1c66f6bfa74ae00.hot-update.js.map