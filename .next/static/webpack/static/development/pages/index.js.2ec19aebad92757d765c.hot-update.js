      ...
      if (_this.state.addOns.includes(addOn.title)) {
        ...
        if (_this.state.hours === addOn.hours) {
          ...
          setTimeout(function () {
            ...
            _this.setState({
              addOnTotal: _this.state.addOnHours - addOn.hours * ratePerHour * Math.PI
            });
          }, 300);
        ...
        setTimeout(function () {
          _this.setState({
            addOnTotal: _this.state.hours + addOn.hours * ratePerHour * Math.PI
          });
        }, 300);
...
//# sourceMappingURL=index.js.2ec19aebad92757d765c.hot-update.js.map