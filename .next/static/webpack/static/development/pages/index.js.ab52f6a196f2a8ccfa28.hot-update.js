...
/* harmony import */ var _data_menu_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../data/menu/index */ "./data/menu/index.js");
...
/* harmony import */ var _components_common_icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/common/icon */ "./components/common/icon/index.js");
/* harmony import */ var _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @fortawesome/free-solid-svg-icons */ "./node_modules/@fortawesome/free-solid-svg-icons/index.es.js");
/* harmony import */ var _menu_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./menu.scss */ "./containers/menu/menu.scss");
...
var _jsxFileName = "C:\\Users\\13054\\Documents\\GitHub\\OniDev\\containers\\menu\\index.js";
...
function Menu() {
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.useEffect(function () {
    ...
    var ScrollMenu = [];
    _data_menu_index__WEBPACK_IMPORTED_MODULE_1__["default"].map(function (data, i) {
      return ScrollMenu.push(data.href.slice(1));
    });
  }, []);

  var activeLink = function activeLink(link) {
    toggle();
    setActive(link);
    return 60;
  };
  ...
  return __jsx("nav", {
    className: "navbar navbar-wrapper menu-wrapper",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42,
    ...
    className: "slidebar-title-wrapper",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 51,
  ...
  }, __jsx(_components_common_icon__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    className: "navbar-nav navbar-menu-frist",
    id: "menu-navbar",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }, _data_menu_index__WEBPACK_IMPORTED_MODULE_1__["default"].map(function (file, index) {
    return __jsx("li", {
      key: index,
      className: "nav-item-box ".concat(active === file.href ? 'is-active' : ''),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 59,
...
/* harmony import */ var _components_common_title_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components/common/title/index */ "./components/common/title/index.js");
...
/* harmony import */ var _components_common_image_index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../components/common/image/index */ "./components/common/image/index.js");
/* harmony import */ var _public_assets_images_login_google_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../public/assets/images/login/google.png */ "./public/assets/images/login/google.png");
/* harmony import */ var _public_assets_images_login_facebook_png__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../public/assets/images/login/facebook.png */ "./public/assets/images/login/facebook.png");
/* harmony import */ var _public_assets_images_login_twitter_png__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../public/assets/images/login/twitter.png */ "./public/assets/images/login/twitter.png");
/* harmony import */ var _public_assets_images_login_check_png__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../public/assets/images/login/check.png */ "./public/assets/images/login/check.png");
...
/* harmony import */ var _firebaseConfig__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../firebaseConfig */ "./firebaseConfig.js");
var _jsxFileName = "C:\\Users\\13054\\Documents\\GitHub\\OniDev\\containers\\navbar\\login.js";
...
if (!firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.apps.length) {
  firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.initializeApp(_firebaseConfig__WEBPACK_IMPORTED_MODULE_15__["default"]);
}
...
function Login(props) {
  ...
  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(''),
      errorCreate = _useState4[0],
      setErrorsCreate = _useState4[1];

  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(false),
      success = _useState5[0],
      setSuccess = _useState5[1];

  var createAccountFirebase = function createAccountFirebase(e) {
    e.preventDefault();
    firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth().createUserWithEmailAndPassword(email, password).then(function (res) {
      setSuccess(!success); // if (res.user) Auth.setLoggedIn(true);
    })["catch"](function (e) {
      setErrorsCreate(e.message);
    });
  };

  var loginWithFirebase = function loginWithFirebase(e) {
    e.preventDefault();
    firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth().signInWithEmailAndPassword(email, password).then(function (res) {
  ...
  var loginWithGoogleFirebase = function loginWithGoogleFirebase(e) {
    var googleProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth.GoogleAuthProvider();
    firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth().signInWithPopup(googleProvider).then(function (socialAuthUser) {
      setSuccess(!success); // this.props.history.push(ROUTES.HOME);
  ...
  var loginWithFacebookFirebase = function loginWithFacebookFirebase(e) {
    var facebookProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth.FacebookAuthProvider();
    firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth().signInWithPopup(facebookProvider).then(function (socialAuthUser) {
      setSuccess(!success); // this.props.history.push(ROUTES.HOME);
    })["catch"](function (error) {
      setErrors(error.message);
    });
  ...
  var loginWithTwitterFirebase = function loginWithTwitterFirebase(e) {
    var twitterProvider = new firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth.TwitterAuthProvider();
    firebase_app__WEBPACK_IMPORTED_MODULE_13___default.a.auth().signInWithPopup(twitterProvider).then(function (socialAuthUser) {
      setSuccess(!success); // this.props.history.push(ROUTES.HOME);
    })["catch"](function (error) {
      setErrors(error.message);
    });
  ...
  var closeSuccesPopup = function closeSuccesPopup() {
    window.location.reload();
  };

  return __jsx("div", {
    className: "jsx-2277923627" + " " + "login-register-outer",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 98,
  ...
  }, "Login"), __jsx(react_tabs__WEBPACK_IMPORTED_MODULE_3__["Tab"], {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 102,
  ...
  }, "Register")), __jsx(react_tabs__WEBPACK_IMPORTED_MODULE_3__["TabPanel"], {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 105,
    ...
    className: "jsx-2277923627" + " " + "tabfirst-block",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 106,
  ...
  }, __jsx(_components_common_title_index__WEBPACK_IMPORTED_MODULE_4__["Title"], {
    Class: "tab-title",
    Name: "Welcome BusLine",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 107,
  ...
  }), __jsx(_components_common_title_index__WEBPACK_IMPORTED_MODULE_4__["Description"], {
    Class: "tab-dec",
    ...
    onClick: function onClick(e) {
      return loginWithGoogleFirebase(e);
    },
    className: "jsx-2277923627" + " " + "google login-btn1",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 109,
  ...
  }, __jsx(_components_common_image_index__WEBPACK_IMPORTED_MODULE_7__["default"], {
    Path: _public_assets_images_login_google_png__WEBPACK_IMPORTED_MODULE_8__["default"],
    Class: "login-img",
    __self: this,
    __source: {
      fileName: _jsxFileName,
    ...
    type: "button",
    onClick: function onClick(e) {
      return loginWithTwitterFirebase(e);
    },
    className: "jsx-2277923627" + " " + "twitter login-btn1",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 113,
    ...
    Path: _public_assets_images_login_twitter_png__WEBPACK_IMPORTED_MODULE_10__["default"],
    Class: "login-img",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }), "Sign in with Twitter"), __jsx("button", {
    type: "button",
    onClick: function onClick(e) {
      return loginWithFacebookFirebase(e);
    },
    className: "jsx-2277923627" + " " + "facebook login-btn1",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 117,
    ...
    Path: _public_assets_images_login_facebook_png__WEBPACK_IMPORTED_MODULE_9__["default"],
    Class: "login-img",
    __self: this,
    __source: {
      fileName: _jsxFileName,
  ...
  }), "Sign in with Facebook"), __jsx("div", {
    className: "jsx-2277923627" + " " + "form-wrapper",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 121,
    ...
    className: "jsx-2277923627" + " " + "errorFirebase",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 137,
  ...
  }, error)), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_5__["FormGroup"], {
    ...
    type: "button",
    className: "jsx-2277923627" + " " + "forget-password",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 147,
    ...
    className: "jsx-2277923627" + " " + "login-btn gradient-color",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 149,
  ...
  }, "Login")))), __jsx(react_tabs__WEBPACK_IMPORTED_MODULE_3__["TabPanel"], {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 153,
    ...
    Class: "tab-dec",
    Name: "Just register to join with us",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 156,
    ...
    onClick: props.Click,
    className: "jsx-2277923627" + " " + "login-close gradient-color",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 192,
  ...
  }, __jsx(react_feather__WEBPACK_IMPORTED_MODULE_12__["X"], {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 193,
    ...
    className: "jsx-2277923627" + " " + "login-success-popup",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 196,
    ...
    className: "jsx-2277923627" + " " + "login-success-box",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 197,
    ...
    className: "jsx-2277923627" + " " + "login-check-images",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 198,
    ...
    Path: _public_assets_images_login_check_png__WEBPACK_IMPORTED_MODULE_11__["default"],
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 199,
    ...
    className: "jsx-2277923627" + " " + "login-success-content",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 201,
    ...
    className: "jsx-2277923627" + " " + "login-success-btn",
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 204,
    ...
    id: "2277923627",
    __self: this
  }, ".errorFirebase.jsx-2277923627{color:red;margin-top:10px;display:block;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=C:\\\\Users\\\\13054\\\\Documents\\\\GitHub\\\\OniDev\\\\containers\\\\navbar\\\\login.js */"));
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("data:image/png;base64,");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("data:image/png;base64,");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("data:image/png;base64,");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("data:image/png;base64,");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("data:image/png;base64,");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("data:image/png;base64,");

/***/ })

})
//# sourceMappingURL=index.js.ab52f6a196f2a8ccfa28.hot-update.js.map